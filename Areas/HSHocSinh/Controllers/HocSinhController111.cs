...
namespace QuanLySV.Areas.HSHocSinh.Controllers
{
    ...
    public class HocSinhController111 : Controller
    {
        private readonly DataDbContext _context;

        public HocSinhController111(DataDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index([FromQuery(Name = "p")]int currentPage, [FromQuery(Name = "size")]int pagesize)
        {
            ...
            ViewBag.totalLopHoc = totalHocSinh;
        ...
        public async Task<IActionResult> Create([Bind("name,HomeAdress,BirthDate,SDT,Gender")] HocSinh hocSinh)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("name,HomeAdress,BirthDate,SDT,Gender")] HocSinh hocSinh)
        {
            if (ModelState.IsValid)
            {
